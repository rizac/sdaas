...
SNIPPET, ADD THE THREE LINES OF TEXT BELOW:
THE CODE SNIPPET BELOW IS AUTOGENERATED WHEN RUNNING TESTS. SEE tests/test_and_create_readme_snippet.py
```
```
(THE FIRST LINE SHOULD BE WRAPPED IN HTML COMMENTS CHARACTERS, AND IT'S THE LINE WHICH
SHOULD WARN 'SNIPPET IS COMING'. THE NEXT CHARACTERS ``` ARE THE SNIPPET START AND END 
STRINGS). THEN, IMPLEMENT IN tests/test_and_create_readme_snippet.py:create_readme_snippet 
THE SNIPPET CODE (IN THE RIGHT POSITION CORRESPONDING TO THE SNIPPET INDEX)
-->
