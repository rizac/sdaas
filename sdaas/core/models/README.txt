# To copy a trained model, from within the root directory of this project
# from the repository 'sod' ($PATH is usually '..'):
...
Evaluation results
(t=n_estimators, psi=max_samples, r=random_state, aps= average_precision_score):
